...
3.  **Phase 3:** Upload 1 year-long data set for each of the following science centers: SEFSC, NEFSC, PIFSC, AFCS (Dan w FMC data experts). *Deadline: June 2024*
...
5.  **Phase 5:** FLAC revisit: FLAC data and rerun all detectors for a second time to evaluate differences between non-FLAC data (Dan, Ludo, Taiki). *Deadline: October 2024*
